...
l10n.ITEM_SUB_TYPE_LIST = {
	...
	[CT._ITEM_CLASS_GEM] = not CT.ISCLASSIC and {					--	3	Gem
		...
		[CT._ITEM_GEM_INTELLECT] = "지능", 				--	0
		[CT._ITEM_GEM_AGILITY] = "민첩", 					--	1
		[CT._ITEM_GEM_STRENGTH] = "힘", 				--	2
		[CT._ITEM_GEM_STAMINA] = "체력", 					--	3
		[CT._ITEM_GEM_SPIRIT] = "정신력", 					--	4
		[CT._ITEM_GEM_CRITICALSTRIKE] = "크리티컬", 	--	5
		[CT._ITEM_GEM_MASTERY] = "숙련", 					--	6
		[CT._ITEM_GEM_HASTE] = "가속", 						--	7
		[CT._ITEM_GEM_VERSATILITY] = "유연성", 			--	8
		[9] = "Other", 										--	9
		[CT._ITEM_GEM_MULTIPLESTATS] = "다속성", 	--	10
		[CT._ITEM_GEM_ARTIFACTRELIC] = "유물", 	--	11
	},
