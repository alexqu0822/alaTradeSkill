...
l10n.ITEM_TYPE_LIST = {
	...
	[CT._ITEM_CLASS_GEM] = "宝石",						--	3	Gem
	[CT._ITEM_CLASS_ARMOR] = "护甲",						--	4	Armor
	[CT._ITEM_CLASS_REAGENT] = "材料",					--	5	Reagent Obsolete
	[CT._ITEM_CLASS_PROJECTILE] = "弹药",				--	6	Projectile Obsolete
...
l10n.ITEM_SUB_TYPE_LIST = {
	...
	[CT._ITEM_CLASS_WEAPON] = {				--	2	Weapon
		[CT._ITEM_WEAPON_AXE1H] = "单手斧",			--	0	--	One-Handed Axes
		[CT._ITEM_WEAPON_AXE2H] = "双手斧",			--	1	--	Two-Handed Axes
		[CT._ITEM_WEAPON_BOWS] = "弓",				--	2	--	Bows
		[CT._ITEM_WEAPON_GUNS] = "枪",				--	3	--	Guns
		[CT._ITEM_WEAPON_MACE1H] = "单手锤",			--	4	--	One-Handed Maces
		[CT._ITEM_WEAPON_MACE2H] = "双手锤",			--	5	--	Two-Handed Maces
		[CT._ITEM_WEAPON_POLEARM] = "长柄武器",		--	6	--	Polearms
		[CT._ITEM_WEAPON_SWORD1H] = "单手剑",		--	7	--	One-Handed Swords
		[CT._ITEM_WEAPON_SWORD2H] = "双手剑",		--	8	--	Two-Handed Swords
		[CT._ITEM_WEAPON_WARGLAIVE] = "战刃",		--	9	--	Warglaives
	...
	[CT._ITEM_CLASS_GEM] = not CT.ISCLASSIC and {					--	3	Gem
		[CT._ITEM_GEM_RED] = "红色宝石",					--	0	--	Intellect
		[CT._ITEM_GEM_BLUE] = "蓝色宝石",				--	1	--	Agility
		[CT._ITEM_GEM_YELLOW] = "黄色宝石",				--	2	--	Strength
		[CT._ITEM_GEM_PURPLE] = "紫色宝石",				--	3	--	Stamina
		[CT._ITEM_GEM_GREEN] = "绿色宝石",				--	4	--	Spirit
		[CT._ITEM_GEM_ORANGE] = "橙色宝石",				--	5	--	Critical Strike
		[CT._ITEM_GEM_META] = "多彩宝石",				--	6	--	Mastery
		[CT._ITEM_GEM_SIMPLE] = "简单宝石",				--	7	--	Haste
		[CT._ITEM_GEM_PRISMATIC] = "棱彩宝石",			--	8	--	Versatility
	} or {
		...
		[CT._ITEM_GEM_CRITICALSTRIKE] = "爆击",		--	5	--	Critical Strike
		[CT._ITEM_GEM_MASTERY] = "精通",				--	6	--	Mastery
		[CT._ITEM_GEM_HASTE] = "急速",				--	7	--	Haste
		[CT._ITEM_GEM_VERSATILITY] = "全能",			--	8	--	Versatility
		[9] = "Other",								--	9	--	Other
		[CT._ITEM_GEM_MULTIPLESTATS] = "多属性",		--	10	--	Multiple Stats
		[CT._ITEM_GEM_ARTIFACTRELIC] = "神器圣物",	--	11	--	Artifact Relic
	},
	...
	[CT._ITEM_CLASS_RECIPE] = {				--	9	Recipe
		[CT._ITEM_RECIPE_BOOK] = "书籍",					--	0	--	Book
		[CT._ITEM_RECIPE_LEATHERWORKING] = "制皮",		--	1	--	Leatherworking
		[CT._ITEM_RECIPE_TAILORING] = "裁缝",			--	2	--	Tailoring
		[CT._ITEM_RECIPE_ENGINEERING] = "工程学",		--	3	--	Engineering
		[CT._ITEM_RECIPE_BLACKSMITHING] = "锻造",		--	4	--	Blacksmithing
		[CT._ITEM_RECIPE_COOKING] = "烹饪",				--	5	--	Cooking
		[CT._ITEM_RECIPE_ALCHEMY] = "炼金术",			--	6	--	Alchemy
		[CT._ITEM_RECIPE_FIRST_AID] = "急救",			--	7	--	First Aid
		[CT._ITEM_RECIPE_ENCHANTING] = "附魔",			--	8	--	Enchanting
		[CT._ITEM_RECIPE_FISHING] = "钓鱼",				--	9	--	Fishing
		[CT._ITEM_RECIPE_JEWELCRAFTING] = "珠宝加工",	--	10	--	Jewelcrafting
		[CT._ITEM_RECIPE_INSCRIPTION] = "铭文",			--	11	--	Inscription
	},
